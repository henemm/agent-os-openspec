...
- **Global-Lauf shadowed Projekt-Commands (Issue #87, bestätigt):** Claude Code
  ...
  sind alle 6 `disable-model-invocation: true`-Skills (Volltext-Einbettung, siehe
  ...
  statt global ausführen, sobald ein Projekt eine eigene Version eines der 6 Namen
